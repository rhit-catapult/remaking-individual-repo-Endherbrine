...
pygame.display.set_caption("Aiden Wang")
# 00: Change the window caption to say your name.
...
# 05: Change the window size, make sure your circle code still works.
...
while True:
    ...
    #  01: Make the background white by uncommenting the line below
    screen.fill(pygame.Color("Gray"))

    # Draw things on the screen

    # 02: Try to draw a circle (any size, any color, anywhere)
